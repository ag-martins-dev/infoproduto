...
export const PlanCard = () => {
  return (
    <div className="flex w-full flex-col items-center justify-center gap-8 rounded-3xl bg-white p-10 ring ring-zinc-200 md:w-2/3 lg:w-2/6">
      ...
      <div>
        <div className="flex flex-col items-center justify-center gap-1">
          <s className="text-base/relaxed text-zinc-500">{numberToBrl(47)}</s>
          <b className="text-6xl/tight font-bold text-emerald-500 md:text-7xl/tight">
            {numberToBrl(14.99)}
          </b>
          <p className="text-sm/relaxed text-zinc-500 md:text-base/relaxed">
            pagamento único.
          </p>
      ...
      <ul className="space-y-5">
        {planFeatures.map(({ id, feature }) => (
          <li key={id} className="flex items-center gap-2">
            ...
            <span className="text-base/relaxed text-zinc-500 md:text-lg/relaxed">
              {feature}
            </span>
          </li>
        ))}
